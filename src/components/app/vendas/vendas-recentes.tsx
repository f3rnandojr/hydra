...
export function VendasRecentes({ onEditarVenda, onVendaAtualizada }: VendasRecentesProps) {
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-right ml-4">
                    ...
                    <div className="flex gap-1 mt-2">
                      <Button size="sm" variant="ghost" onClick={() => onEditarVenda?.(venda)} disabled={!isVendaEditavel(venda)} title={isVendaEditavel(venda) ? "Editar venda" : "Venda não pode ser editada"}>
